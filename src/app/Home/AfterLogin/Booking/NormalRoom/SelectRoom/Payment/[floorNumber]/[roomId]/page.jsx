...
export default function PaymentPage({ params }) {
  ...
  const handleConfirm = () => {
    ...
    alert(`Booking confirmed for Room ${roomId} on Floor ${floorNumber} (Normal Room).
    ...
    <div className={styles.container}>
      ...
      <div className={styles.paymentBox}>
        <h2 className={styles.roomInfo}>
          {floorNumber} Floor Room {roomId} (Normal Room)
        </h2>
        ...
        <form className={styles.form}>
          ...
          <div className={styles.price}>3,500 BAHT</div>
